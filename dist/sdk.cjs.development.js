...
var IBulletPair = _interopDefault(require('@bullet-finance/bullet-swap-core/build/IBulletPair.json'));
...
var FACTORY_ADDRESS = '0xF2AD65834519Da1483dC2A0AF8e875C0a37077f1';
var INIT_CODE_HASH = '0x8ac3874bc06af8110495e73feac3396c4be79629182a64ec461749996d939702';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IBulletPair.abi, provider).getReserves()).then(function (_ref) {
